...
! function(e, t) {
	...
	function V(e, t) {
		...
		if(n) {
			var r, i, o = {};
			if(Array.isArray(n))
				for(r = n.length; r--;) "string" == typeof(i = n[r]) && (o[Ni(i)] = {
					type: null
				});
			else if(a(n))
				for(var s in n) i = n[s], o[Ni(s)] = a(i) ? i : {
					type: i
				};
			e.props = o
		}
	...
	function Re(e, t) {
		...
		if((i || o(e)) && Object.isExtensible(e)) {
			...
			if(i)
				for(n = e.length; n--;) Re(e[n], t);
			else
				for(n = (r = Object.keys(e)).length; n--;) Re(e[r[n]], t)
		}
	}
	...
	function Dr(e) {
		...
		for(t = 0, n = c.length; t < n; t++)
			if(r = i = c[t].name, o = c[t].value, Us.test(r))
				if(e.hasBindings = !0, (a = Fr(r)) && (r = r.replace(qs, "")), Js.test(r)) r = r.replace(Js, ""), o = an(o), s = !1, a && (a.prop && (s = !0, "innerHtml" === (r = Ni(r)) && (r = "innerHTML")), a.camel && (r = Ni(r)), a.sync && pn(e, "update:" + Ni(r), yn(o, "$event"))), s || !e.component && Ts(e.tag, e.attrsMap.type, r) ? ln(e, r, o) : fn(e, r, o);
	...
	var Vo = {
			init: function(e, t, n, r) {
				if(!e.componentInstance || e.componentInstance._isDestroyed)(e.componentInstance = ht(e, jo, n, r)).$mount(t ? e.elm : void 0, t);
	...
	var Zo, Yo, Qo, Xo, ea, ta, na, ra, ia = f("style,class"),
	...
	var ws, xs, ks, As, Os, Ss, Ts, Es, js, Ns, Ls, Is = f("script,style,textarea", !0),
		Ms = {},
		Ds = {
			"&lt;": "<",
			"&gt;": ">",
